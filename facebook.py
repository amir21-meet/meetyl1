...
user2 = User("Mousa","mousa@gmail.com","meet",0,0)
users_name={user1.name,user2.name}
users_password={user1.password,user2.password}
users_friend={user1.name,user2.name}
friends_list=[]
user_post=[]
yes=("y,yes,Yes,YES")
no = ("no,no,No,NO")
